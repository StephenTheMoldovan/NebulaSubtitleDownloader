...
:: replace "a." with the link to the first vtt segment which can be found in the Network tab of your browser when you first start the video
...
:: (to find out, skip to the end of the video and find the vtt segment in the Network tab that contains the last subtitle(s) shown in the video)
for /l %%x in (1, 1, b) do (
